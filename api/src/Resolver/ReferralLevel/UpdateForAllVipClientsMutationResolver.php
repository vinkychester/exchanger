...
class UpdateForAllVipClientsMutationResolver implements MutationResolverInterface
{
    ...
    public function __invoke($item, array $context)
    {
        ...
        $updateLevelForAllVipLevelsSQL = $this->referralClientLevelRepository->updateLevelForAllSelectedClientsLevelsSQL(
            $this->referralClientLevelRepository->getClientVipLevelsSQL($referralLevel->getLevel()),
            $referralLevel->getId()
        );
